...
interface UXUIDashboardProps {
  data: SurveyResponse[];
  insights: CategoryInsights;
}

export function UXUIDashboard({ data, insights }: UXUIDashboardProps) {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-medium">UX/UI Analysis</h1>
        <p className="text-muted-foreground mt-2">
          Detailed insights and feedback analysis for user experience and interface
        </p>
      </div>

      {/* Category Criteria */}
      <CategoryCriteria criteria="Comments about intuitiveness, design, usability or learning curve." />
