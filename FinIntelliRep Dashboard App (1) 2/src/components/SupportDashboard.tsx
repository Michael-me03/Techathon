...
export function SupportDashboard({ data, insights }: SupportDashboardProps) {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-medium">Support Analysis</h1>
        <p className="text-muted-foreground mt-2">
          Detailed insights and feedback analysis for customer support
        </p>
      </div>

      {/* Category Criteria */}
      <CategoryCriteria criteria="Comments about help, documentation, onboarding, responsiveness." />
