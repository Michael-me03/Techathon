...
export function PerformanceDashboard({ data, insights }: PerformanceDashboardProps) {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-medium">Performance Analysis</h1>
        <p className="text-muted-foreground mt-2">
          Detailed insights and feedback analysis for system performance
        </p>
      </div>

      {/* Category Criteria */}
      <CategoryCriteria criteria="Comments about speed, stability, crashes or load times." />
